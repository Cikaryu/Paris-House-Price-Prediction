...
from featureengineering import engine
...
with st.sidebar:
    selected = option_menu(
        ...
        options=["Pengenalan","Dokumentasi","Data Exploration","Feature Selection","Feature Engineering","Data Splitting","Prediction"],
        menu_icon="cast",
        default_index = 0,  
    )
